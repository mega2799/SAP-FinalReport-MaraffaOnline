...
\textbf{Aggregates} (giallo):
\begin{itemize}
    \item \texttt{User} -- gestisce registrazione, autenticazione, profilo
    \item \texttt{Game} -- invariante principale: esattamente 4 giocatori, 2 team; governa il ciclo di vita della partita
    \item \texttt{Round} -- invariante: distribuzione corretta delle carte, regole della presa, calcolo punteggio
\end{itemize}
